...
- **Rich components** — Clock, weather (auto-fetched, no API key required), text, image, iframe
...
### 6. Trigger emergency alerts (optional)
...
- **丰富组件** — 时钟、天气（自动获取，无需 API Key）、文本、图片、网页嵌入（iframe）
